...
func giveSwordEmperorSwordSoul(t *testing.T, game *GameEngine, playerID, cardID string) {
	t.Helper()
...
func prepareSwordEmperorActiveTurn(game *GameEngine, playerID string, hand []model.Card) *model.Player {
	player := game.State.Players[playerID]
...
func TestSwordEmperor_AngelSoul_MissDisablesGuardAndAddsMorale(t *testing.T) {
	...
	chooseResponseSkillByID(t, game, "p1", "se_angel_soul")
	mustHandleAction(t, game, model.PlayerAction{
		PlayerID:  "p2",
		Type:      model.CmdRespond,
		CardIndex: 0,
...
func TestSwordEmperor_DemonSoul_HitAddsDamage(t *testing.T) {
	...
	chooseResponseSkillByID(t, game, "p1", "se_demon_soul")
	mustHandleAction(t, game, model.PlayerAction{
		PlayerID:  "p2",
		Type:      model.CmdRespond,
		ExtraArgs: []string{"take"},
...
func TestSwordEmperor_SwordQiSlash_ExcludeOriginalTargetAndDealMagicDamage(t *testing.T) {
	...
	chooseResponseSkillByID(t, game, "p1", "se_sword_qi_slash")
	requireChoicePrompt(t, game, "p1", "se_sword_qi_slash_x")
	...
	requireChoicePrompt(t, game, "p1", "se_sword_qi_slash_target")
