...
func (e *GameEngine) buildHeroChoicePrompt(choiceType, playerID string, _ *model.Player, _ map[string]interface{}) *model.Prompt {
	switch choiceType {
	case "hero_roar_draw":
		return &model.Prompt{
...
func (e *GameEngine) handleHeroChoiceInput(_ string, selectionIndex int, ctxData map[string]interface{}) (bool, error) {
