...
func TestValkyrie_HeroicSummon_DoesNotEnterSpiritOnCounterHit(t *testing.T) {
	...
	testutils.ChooseResponseSkillByID(t, game, "p2", "valkyrie_heroic_summon")
...
func TestValkyrie_MilitaryGlory_BranchTwoDoesNotExitSpirit(t *testing.T) {
	...
	testutils.RequireChoicePrompt(t, game, "p1", "valkyrie_military_glory_mode")
	...
	testutils.MustHandleAction(t, game, model.PlayerAction{PlayerID: "p1", Type: model.CmdSelect, Selections: []int{targetSelection}})
