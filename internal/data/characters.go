	...
	characters := []model.Character{
			...
			Skills: []model.SkillDefinition{
				{
					...
					// 额外触发：由自己放置【圣盾】等基础效果时
					ExtraTriggers: []model.TriggerType{model.TriggerOnBuffAdded},
			...
			Skills: []model.SkillDefinition{
				{
					...
					Trigger:       model.TriggerModifyDamage,
					ExtraTriggers: []model.TriggerType{model.TriggerOnAttackHit},
		...
		// 3. 封印师
		{
			...
			Skills: []model.SkillDefinition{
				...
				},
				{
					...
					PlaceTrigger:     model.EffectTriggerOnBeforeAction, // 行动阶段开始前触发
				...
				},
				{
					...
					PlaceTrigger:     model.EffectTriggerOnCardPlayedOrRevealed, // 打出或展示对应元素牌时触发
		...
		// 5. 神箭手
		{
			...
			Skills: []model.SkillDefinition{
				...
				},
				{
					...
					Trigger:          model.TriggerOnAttackStart,
					ExtraTriggers:    []model.TriggerType{model.TriggerModifyDamage},
					RequiredRole:     model.RoleAttacker,   // Only triggers when attacking
			...
			Skills: []model.SkillDefinition{
				{
					...
					Trigger:      model.TriggerNone, // 由 PerformMagic 的魔弹链路主动触发
				...
				},
				{
					...
					Trigger:      model.TriggerNone, // 由 PerformMagic 的法术改写链路主动触发
		...
		// 33. 兽灵武士
		{
			...
			Skills: []model.SkillDefinition{
				...
				{
					ID:           "bs_iaijutsu_turn_end_drain",
					Title:        "御魂流居合形态·回合结束扣魂",
					Type:         model.SkillTypePassive,
				...
				{
					ID:           "bs_iaijutsu_exit_on_deal_damage",
					Title:        "御魂流居合形态·造成伤害退场",
					Type:         model.SkillTypePassive,
				...
				{
					ID:           "bs_iaijutsu_exit_on_zero",
					Title:        "御魂流居合形态·兽魂归零退场",
					Type:         model.SkillTypePassive,
				...
				{
					ID:           "bs_iaijutsu_tapped_target_boost",
					Title:        "御魂流居合形态·横置目标增伤",
					Type:         model.SkillTypePassive,
