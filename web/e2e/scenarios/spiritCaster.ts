...
export function hundredNightSingleTargetPrompt(): WsMessage {
  return requireActionMessage({
    ...
    options: [
      { id: SC_PLAYER_ID, target_id: SC_PLAYER_ID, label: 'E2E Spirit Caster', button_label: '选择' },
      { id: ENEMY_PLAYER_ID, target_id: ENEMY_PLAYER_ID, label: 'Enemy E1', button_label: '选择' },
      { id: ENEMY_2_PLAYER_ID, target_id: ENEMY_2_PLAYER_ID, label: 'Enemy E2', button_label: '选择' },
      { id: ENEMY_3_PLAYER_ID, target_id: ENEMY_3_PLAYER_ID, label: 'Enemy E3', button_label: '选择' },
    ],
    min: 1,
    max: 1,
  } satisfies Prompt);
