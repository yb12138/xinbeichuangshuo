...
export function scarletCovenantPrompt(): WsMessage {
  return requireActionMessage({
    ...
    choice_type: 'rlk_scarlet_covenant',
    options: [
      { id: 'confirm', label: '发动' },
      { id: 'skip', label: '跳过' },
    ],
...
export function bloodyPrayerXPrompt(): WsMessage {
  return requireActionMessage({
    ...
    choice_type: 'rlk_bloody_prayer_x',
    options: [
      { id: '1', label: '移除1治疗' },
      { id: '2', label: '移除2治疗' },
    ],
...
export function bloodyPrayerTargetPrompt(): WsMessage {
  return requireActionMessage({
    ...
    choice_type: 'rlk_bloody_prayer_target',
    options: [
...
export function slaughterFeastPrompt(): WsMessage {
  return requireActionMessage({
    ...
    choice_type: 'rlk_slaughter_feast',
    options: [
      { id: 'confirm', label: '发动' },
      { id: 'skip', label: '跳过' },
    ],
...
export function modestyBranchPrompt(): WsMessage {
  return requireActionMessage({
    ...
    choice_type: 'rlk_modesty_branch',
    options: [
      { id: 'draw', label: '摸2张牌' },
      { id: 'heal', label: '+2治疗' },
    ],
...
export function scarletCrossDiscardPrompt(): WsMessage {
  return requireActionMessage({
    ...
    choice_type: 'rlk_scarlet_cross_discard',
    options: [
...
export function scarletCrossTargetPrompt(): WsMessage {
  return requireActionMessage({
    ...
    choice_type: 'rlk_scarlet_cross_target',
    options: [
      { id: ENEMY_PLAYER_ID, label: 'Enemy E1' },
    ],
    min: 1, max: 1,
